<div class="main-header">
    ...
    <div class="logo-header"
        ...
        <a href="index.html"
           class="logo">
            <img src="{{ asset('back/assets/img/logo.svg') }}"
                 alt="navbar brand"
                 class="navbar-brand">
        </a>
            ...
            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                    ...
                    <ul class="dropdown-menu messages-notif-box animated fadeIn"
                        ...
                        <li>
                            <div class="dropdown-title d-flex justify-content-between align-items-center">
                                Messages
                                <a href="#"
                                   class="small">Mark all as read</a>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="see-all"
                               href="javascript:void(0);">See all messages<i class="fa fa-angle-right"></i> </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown hidden-caret">
                    ...
                    <ul class="dropdown-menu notif-box animated fadeIn"
                        ...
                        <li>
                            <a class="see-all"
                               href="javascript:void(0);">See all notifications<i class="fa fa-angle-right"></i>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic"
                       ...
                       aria-expanded="false">
                        <div class="avatar-sm">
                            <img src=" back/assets/img/profile.jpg"
                                 alt="..."
